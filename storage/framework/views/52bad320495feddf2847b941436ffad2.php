<?php $__env->startSection('title', 'Pembayaran Mingguan - Sederhana'); ?>
            ...
            <section class="greeting-section mb-8">
                <div class="greeting-card">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <a href="?month=<?php echo e($prevMonth ?? ($month == 1 ? 12 : $month - 1)); ?>&year=<?php echo e($prevYear ?? ($month == 1 ? $year - 1 : $year)); ?>" class="nav-btn">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                            Bulan Sebelumnya
                        </a>
                        <div class="text-center">
                            <h1 class="greeting-title"><?php echo e($currentMonthName ?? \Carbon\Carbon::create($year ?? now()->year, $month ?? now()->month)->locale('id')->translatedFormat('F Y')); ?></h1>
                            <p class="greeting-subtitle">Pembayaran Mingguan Siswa</p>
                        </div>
                        <a href="?month=<?php echo e($nextMonth ?? ($month == 12 ? 1 : $month + 1)); ?>&year=<?php echo e($nextYear ?? ($month == 12 ? $year + 1 : $year)); ?>" class="nav-btn">
                            Bulan Selanjutnya
            ...
            <section class="stats-section mb-8">
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($paidBills ?? 0); ?></div>
                        <div class="stat-description">Dari <?php echo e($totalBills ?? 0); ?> total tagihan</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-header">
                        ...
                        <div class="stat-value"><?php echo e($unpaidBills ?? 0); ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">Rp <?php echo e(number_format($paidAmount ?? 0, 0, ',', '.')); ?></div>
            ...
            <?php if(!empty($pendingAdjustmentCount) && $pendingAdjustmentCount > 0): ?>
                <section class="mb-8">
                    <div class="bg-indigo-50 border border-indigo-200 rounded-xl p-4">
                        <h3 class="text-lg font-semibold text-indigo-800">⚠️ Ada <?php echo e($pendingAdjustmentCount); ?> penyesuaian pembayaran pending</h3>
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php
                                    $studentIndex = 0;
                                ?>
                                <?php $__empty_1 = true; $__currentLoopData = $paymentsByStudent ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentId => $payments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                    $index = ++$studentIndex;
                                    $paidCount = $payments->where('status', 'paid')->count();
                                ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="text-center font-semibold"><?php echo e($index); ?></td>
                                    <td class="font-semibold"><?php echo e($payments->first()->student->name ?? 'Unknown'); ?></td>
                                    <?php for($week = 1; $week <= 4; $week++): ?>
                                        ...
                                        <td class="text-center">
                                            <span class="status-badge <?php echo e($status); ?>"><?php echo e($icon); ?></span>
                                        </td>
                                    <?php endfor; ?>
                                    <td class="text-center font-bold">
                                        <span class="status-badge <?php echo e($paidCount == 4 ? 'success' : 'danger'); ?>">
                                            <?php echo e($paidCount); ?>/4
                                        </span>
                                    </td>
                                    <?php
                                    ...
                                    <td class="text-center">
                                        <?php if($pendingAdjustments->isNotEmpty()): ?>
                                            <?php $__currentLoopData = $pendingAdjustments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adjustment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mb-2">
                                                    <span class="status-badge warning">
                                                        <?php echo e($adjustment->isShortage() ? 'Kurang' : 'Lebih'); ?> <?php echo e($adjustment->formatted_amount); ?>

                                                    </span>
                                                    <form action="<?php echo e(route($adjustment->isShortage() ? 'bendahara.adjustment.shortage' : 'bendahara.adjustment.refund', $adjustment->id)); ?>" method="POST" class="inline-block mt-2">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit" class="action-btn">
                                                            <?php echo e($adjustment->isShortage() ? 'Lunasi' : 'Refund'); ?>
                                            ...
                                            <?php if($paidCount < 4): ?>
                                                <button onclick="showPaymentModal(<?php echo e($payments->first()->student->id); ?>, '<?php echo e($payments->first()->student->name); ?>', <?php echo e($month ?? now()->month); ?>, <?php echo e($year ?? now()->year); ?>)" class="action-btn mt-2">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                                                    Bayar
                                                </button>
                                            <?php endif; ?>
                                        <?php elseif($paidCount < 4): ?>
                                            <button onclick="showPaymentModal(<?php echo e($payments->first()->student->id); ?>, '<?php echo e($payments->first()->student->name); ?>', <?php echo e($month ?? now()->month); ?>, <?php echo e($year ?? now()->year); ?>)" class="action-btn">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                                                Bayar
                                            </button>
                                        <?php else: ?>
                                ...
                                <tr>
                                    <td colspan="8" class="text-center py-8 text-gray-500">
                                        Belum ada data pembayaran untuk bulan <?php echo e($currentMonthName ?? \Carbon\Carbon::create($year ?? now()->year, $month ?? now()->month)->locale('id')->translatedFormat('F Y')); ?>
    ...
    <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <form id="paymentForm" class="space-y-4">
            ...
            <div>
                ...
                <div class="p-2 bg-green-100 rounded font-semibold">Rp <?php echo e(number_format($weeklyPaymentAmount, 0, ',', '.')); ?></div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectsc - Copy\resources\views/bendahara/simple-weekly-payments.blade.php ENDPATH**/ ?>