        ...
        <table class="header-table">
            <tr>
                <td class="school-info">
                    ...
                    <div class="period">
                        Periode Januari - <span class="nowrap"><?php echo e($endMonthName); ?></span> Tahun <?php echo e($year); ?>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $monthly; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="text-right">Rp <?php echo e(number_format($row['balance'] ?? 0,0,',','.')); ?></td>

                </tr>

                <?php if(!empty($row['income_details']) && is_array($row['income_details']) && count($row['income_details']) > 0): ?>
                    <?php $__currentLoopData = $row['income_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-right">Rp <?php echo e(number_format($detail['amount'] ?? 0,0,',','.')); ?></td>
