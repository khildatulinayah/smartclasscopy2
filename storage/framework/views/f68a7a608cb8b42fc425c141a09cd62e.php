        ...
        <main class="main-content">
                ...
                <div class="profile-card">
                    <div class="profile-info">
                        <div class="profile-avatar">
                            <img src="<?php echo e($student->profile_photo ? asset('storage/' . $student->profile_photo) : 'https://picsum.photos/seed/' . $student->id . '/120/120.jpg'); ?>" alt="<?php echo e($student->name); ?>" class="avatar-img" id="avatarPreview">
                        ...
                        <div class="profile-details">
                            <h1 class="profile-name"><?php echo e($student->name); ?></h1>
                            ...
                            <div class="profile-meta">
                                ...
                                <span class="meta-item">
                                    ...
                                    Bergabung: <?php echo e($student->created_at->format('d M Y')); ?>
            ...
            <div id="editModal" class="modal">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('siswa.profile.update')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="name" class="form-label">Nama Lengkap</label>
                                <input type="text" id="name" name="name" class="form-input" value="<?php echo e($student->name); ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="gender" class="form-label">Jenis Kelamin</label>
                                <select id="gender" name="gender" class="form-input">
                                    <option value="">-- Pilih Jenis Kelamin --</option>
                                    <option value="L" <?php echo e($student->gender == 'L' ? 'selected' : ''); ?>>Laki-laki</option>
                                    <option value="P" <?php echo e($student->gender == 'P' ? 'selected' : ''); ?>>Perempuan</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" id="email" name="email" class="form-input" value="<?php echo e($student->email); ?>" readonly>
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-content">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value">
                                    <?php if($student->gender): ?>
                                        <span class="gender-badge <?php echo e($student->gender == 'L' ? 'male' : 'female'); ?>">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value"><?php echo e($student->created_at->format('d F Y')); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-content">
                            <div class="info-item">
                                ...
                                <div class="info-value">#<?php echo e(str_pad($student->id, 6, '0', STR_PAD_LEFT)); ?></div>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value"><?php echo e($student->updated_at->diffForHumans()); ?></div>
                            </div>
                            <div class="info-item">
...
document.addEventListener('DOMContentLoaded', function() {
    const successMessage = '<?php echo e(session()->get("success")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectsc - Copy\resources\views/siswa/profile.blade.php ENDPATH**/ ?>