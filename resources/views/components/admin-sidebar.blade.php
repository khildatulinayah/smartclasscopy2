<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.monitor.pembayaran') }}" class="nav-item {{ request()->routeIs('admin.monitor.pembayaran') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('admin.monitor.keuangan') }}" class="nav-item {{ request()->routeIs('admin.monitor.keuangan') ? 'active' : '' }}">
