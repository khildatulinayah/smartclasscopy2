...
<div class="dashboard-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('bendahara.dashboard')); ?>" class="nav-item active">
            ...
            <a href="<?php echo e(route('bendahara.kas')); ?>" class="nav-item">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <span>Keuangan</span>
            </a>
            <a href="<?php echo e(route('bendahara.weekly.payments')); ?>" class="nav-item">
...
<section class="greeting-section">
            ...
            <section class="feature-cards">
                <div class="feature-card">
                    ...
                    <a href="<?php echo e(route('bendahara.kas')); ?>" class="feature-btn">Kelola Keuangan</a>
                </div>
                <div class="feature-card">
                    ...
                    <a href="<?php echo e(route('bendahara.weekly.payments')); ?>" class="feature-btn">Lihat Pembayaran</a>
                </div>
                            </section>

            <?php $paymentPercent = $totalBills > 0 ? round(($paidBills / $totalBills) * 100) : 0; ?>
            ...
            <section class="stats-section">
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">Rp <?php echo e(number_format($monthlyIncome, 0, ',', '.')); ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">Rp <?php echo e(number_format($monthlyExpense, 0, ',', '.')); ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="progress-container">
                            <div class="progress-bar"><div class="progress-fill" style="width: <?php echo e($paymentPercent); ?>%"></div></div>
                            <div class="progress-text"><?php echo e($paidBills); ?>/<?php echo e($totalBills); ?> Lunas</div>
                        </div>
                        <div class="stat-details">
                            <div class="detail-item"><span class="detail-label">Sudah Bayar</span><span class="detail-value"><?php echo e($paidBills); ?> siswa</span></div>
                            <div class="detail-item"><span class="detail-label">Belum Bayar</span><span class="detail-value"><?php echo e($unpaidBills); ?> siswa</span></div>
                        </div>
                    </div>
                    <div class="stat-card">
                        ...
                        <div class="class-info">
                            <div class="info-row"><span class="info-label">Total Siswa:</span><span class="info-value"><?php echo e($totalStudents); ?> siswa</span></div>
                ...
                <div class="table-card">
                    ...
                    <div class="table-container">
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $recentPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($rp->payment_date ? \Carbon\Carbon::parse($rp->payment_date)->format('d M Y') : '-'); ?></td>
                                    <td><?php echo e($rp->student->name ?? '-'); ?></td>
                                    <td>Minggu <?php echo e($rp->week_number); ?></td>
                                    <td>Rp <?php echo e(number_format($rp->amount, 0, ',', '.')); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectsc - Copy\resources\views/bendahara/dashboard.blade.php ENDPATH**/ ?>