...
<style>
    /* Fix: pastikan sidebar tidak ikut "melebar"/tidak memicu horizontal overflow */
    .dashboard-layout {
        min-height: 100vh;
        overflow-x: hidden;
    }

    /* gunakan aside.sidebar biar konsisten dengan markup */
    .sidebar {
        flex: 0 0 auto;
        width: 280px;
        max-width: 280px;
    ...
    /* konten utama tidak boleh memaksa sidebar melebar */
    .main-area {
        min-width: 0;
        flex: 1;
    }

    /* jaga container utama agar tidak menyebabkan wrap panjang */
    .main-content {
        min-width: 0;
        overflow-x: hidden;
    }
