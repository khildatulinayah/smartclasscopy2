...
<div class="dashboard-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.monitor.absensi') }}" class="nav-item">
...
<section class="greeting-section">
            ...
            <section class="stats-section">
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">{{ $totalTidakHadir ?? 0 }}</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">Rp {{ number_format($balance ?? 0, 0, ',', '.') }}</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="progress-container">
                            <div class="progress-bar"><div class="progress-fill" style="width: {{ $presencePercent }}%"></div></div>
                            <div class="progress-text">{{ $presencePercent }}% Bulanan</div>
                        </div>
                        <div class="stat-details">
                            <div class="detail-item"><span class="detail-label">Hadir</span><span class="detail-value">{{ $totalHadir ?? 0 }}</span></div>
                            <div class="detail-item"><span class="detail-label">Total</span><span class="detail-value">{{ $totalStudents ?? 0 }} siswa</span></div>
                        </div>
                    </div>
                    <div class="stat-card">
                        ...
                        <div class="class-info">
                            <div class="info-row"><span class="info-label">Pemasukan:</span><span class="info-value">Rp {{ number_format($totalIncome ?? 0, 0, ',', '.') }}</span></div>
                            <div class="info-row"><span class="info-label">Pengeluaran:</span><span class="info-value">Rp {{ number_format($totalExpense ?? 0, 0, ',', '.') }}</span></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="tables-section">
                <div class="table-card">
                    <div class="table-header"><h2 class="table-title">Siswa Terbaru</h2><a href="{{ route('admin.students') }}" class="feature-btn" style="float:right;font-size:13px;padding:8px 16px;">Kelola Semua →</a></div>
