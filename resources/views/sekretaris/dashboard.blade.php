...
<div class="dashboard-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="{{ route('sekretaris.dashboard') }}" class="nav-item active">
            ...
            <a href="{{ route('sekretaris.tracker') }}" class="nav-item">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                <span>Rekap Absensi</span>
            </a>
            <a href="{{ route('sekretaris.laporan') }}" class="nav-item">
...
<section class="greeting-section">
            ...
            <section class="feature-cards">
                <div class="feature-card">
                    ...
                    <a href="{{ route('sekretaris.absensi') }}" class="feature-btn">Input Absensi</a>
                </div>
                <div class="feature-card">
                    ...
                    <a href="{{ route('sekretaris.tracker') }}" class="feature-btn">Lihat Rekap</a>
                </div>
                <div class="feature-card">
                    ...
                    <a href="{{ route('sekretaris.laporan') }}" class="feature-btn">Buat Laporan</a>
                </div>
            </section>
            ...
            <section class="stats-section">
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-description">Siswa hadir {{ $today }}</div>
                    </div>
                    <div class="stat-card">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="progress-container">
                            ...
                            <div class="progress-text">{{ $stats['hadir'] }}/{{ $stats['total'] }} Hadir</div>
                        </div>
                        <div class="stat-details">
                            <div class="detail-item"><span class="detail-label">Hadir</span><span class="detail-value">{{ $stats['hadir'] }}</span></div>
                            <div class="detail-item"><span class="detail-label">Alpa</span><span class="detail-value">{{ $stats['alpha'] }}</span></div>
                        </div>
                    </div>
                    <div class="stat-card">
                        ...
                        <div class="class-info">
                            <div class="info-row"><span class="info-label">Tanggal:</span><span class="info-value">{{ \Carbon\Carbon::parse($today)->locale('id')->format('d F Y') }}</span></div>
                            @if(isset($holiday))
                            <div class="info-row"><span class="info-label">Status:</span><span class="info-value">📅 Libur: {{ $holiday->note }}</span></div>
                            @else
            ...
            <section class="tables-section">
                <div class="table-card">
                    <div class="table-header"><h2 class="table-title">Absensi Terbaru ({{ $today }})</h2></div>
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item['attendance_time'] ? \Carbon\Carbon::parse($item['attendance_time'])->format('H:i') : '-' }}</td>
                                </tr>
                                @empty
