...
<div class="dashboard-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-item active">
            ...
            <a href="<?php echo e(route('admin.monitor.kas')); ?>" class="nav-item">
...
<section class="greeting-section">
            ...
            <section class="feature-cards">
                ...
                <div class="feature-card">
                    ...
                    <a href="<?php echo e(route('sekretaris.absensi')); ?>" class="feature-btn">Lihat Absensi</a>
                </div>
                <div class="feature-card">
                    ...
                    <a href="<?php echo e(route('bendahara.kas')); ?>" class="feature-btn">Lihat Keuangan</a>
                </div>
            </section>
