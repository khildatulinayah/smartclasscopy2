                ...
                <div class="greeting-card">
                    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 mb-6">
                        <div>
                            ...
                            <p class="greeting-subtitle"><?php echo e(\Carbon\Carbon::create($currentYear, $currentMonth)->locale('id')->format('F Y')); ?></p>
                        </div>
                        <div class="flex flex-wrap gap-2">
                            <a href="?month=<?php echo e(max(1, $currentMonth - 1)); ?>" class="feature-btn px-4 py-2 text-sm" style="background: #6b7280;">
                    ...
                    <div class="flex flex-wrap gap-2" style="overflow-x: auto; padding-bottom: 8px;">
                        <?php for($m = 1; $m <= 12; $m++): ?>
                            <a href="?month=<?php echo e($m); ?>" class="px-3 py-2 text-sm font-medium rounded-full <?php echo e($currentMonth == $m ? 'bg-blue-500 text-white shadow-md' : 'bg-gray-100 hover:bg-gray-200'); ?> transition-all whitespace-nowrap">
                                <?php echo e(\Carbon\Carbon::create($currentYear, $m)->locale('id')->monthName); ?>
...
function showDetail(studentId) {
    ...
    const studentNames = <?php echo json_encode(collect($students->pluck('name', 'id')->toArray()), 512) ?>;
    
    modalTitle.textContent = `Detail Absensi - ${studentNames[studentId]} ($<?php echo e(\Carbon\Carbon::create($currentYear, $currentMonth)->locale('id')->monthName); ?> $<?php echo e($currentYear); ?>)`;
    
    fetch(`/sekretaris/api/student-attendance/${studentId}?month=<?php echo e($currentMonth); ?>&year=<?php echo e($currentYear); ?>`)
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectsc - Copy\resources\views\sekretaris\tracker.blade.php ENDPATH**/ ?>