                            ...
                            <div class="form-group">
                                ...
                                <div class="avatar-upload-container">
                                    <div id="avatarPreview" class="avatar-preview">
                                        <img src="https://ui-avatars.com/api/?name=Nama+Siswa&background=3b82f6&color=fff&size=120" style="width: 100%; height: 100%; border-radius: 16px; object-fit: cover;">
                                    </div>
    ...
    window.previewImage = function(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                avatarPreview.innerHTML = `<img src="${e.target.result}" style="width: 100%; height: 100%; border-radius: 16px; object-fit: cover;">`;
                hasCustomPhoto = true;
            }
