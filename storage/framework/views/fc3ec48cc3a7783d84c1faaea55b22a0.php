...
?>
    ...
    <?php else: ?>
            ...
            <div class="table-header">
                            ...
                            <!-- Table search -->
                            <div class="flex justify-between items-center mt-4 gap-4" style="flex-wrap: wrap;">
                                <div style="flex: 1; min-width: 220px;">
                                    <label class="block text-sm font-medium text-gray-700 mb-2" for="absensiSearch">Cari siswa</label>
                                    <div class="relative">
                                        <input id="absensiSearch" type="search" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Ketik nama siswa..." autocomplete="off">
                                    </div>
                                </div>
                                <div>
                                    <button type="button" id="absensiClearSearch" class="feature-btn" style="background: #f3f4f6; color: #111827; padding: 10px 16px; border: 1px solid #e5e7eb;">
                                        Bersihkan
                                    </button>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const clearBtn = document.getElementById('absensiClearSearch');
    ...
    if (searchInput && table) {
        ...
        const applyFilter = () => {
            ...
            rows.forEach((row) => {
                ...
                const text = (nameCell ? nameCell.innerText : row.innerText).toLowerCase();
