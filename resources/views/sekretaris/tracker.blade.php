...
<div class="dashboard-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="{{ route('sekretaris.dashboard') }}" class="nav-item">
            ...
            <a href="{{ route('sekretaris.tracker') }}" class="nav-item active">
            ...
            <section class="stats-section mb-8">
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-description">{{ isset($totalDays) && $totalDays > 0 ? number_format(($totalHadir / $totalDays) * 100, 1) . '% kehadiran' : '0% kehadiran' }}</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-header">
