...
<div class="dashboard-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('siswa.dashboard')); ?>" class="nav-item active">
...
stroke-dashoffset="<?php echo e($totalDays > 0 ? 326.73 - ($totalHadir / $totalDays * 326.73) : 326.73); ?>"/>
                                </svg>
<div class="progress-text"><?php echo e($totalDays > 0 ? round(($totalHadir / $totalDays) * 100, 0) : 0); ?>%</div>
                            </div>
                        </div>
                        <div class="attendance-breakdown">
                            <div class="breakdown-item">
                                <div class="status-dot present"></div>
<span>Hadir: <?php echo e($totalHadir); ?></span>
                            </div>
                            <div class="breakdown-item">
                                <div class="status-dot sick"></div>
<span>Sakit: <?php echo e($totalSakit); ?></span>
                            </div>
                            <div class="breakdown-item">
                                <div class="status-dot permit"></div>
<span>Izin: <?php echo e($totalIzin); ?></span>
                            </div>
                            <div class="breakdown-item">
                                <div class="status-dot absent"></div>
<span>Alpa: <?php echo e($totalAlpha); ?></span>
                            </div>
                        </div>
                    </div>
...
<div class="payment-month"><?php echo e(\Carbon\Carbon::now()->translatedFormat('F Y')); ?></div>
                        <div class="payment-progress">
                            <div class="progress-bar">
                                <div class="progress-fill" style="width: 75%"></div>
                            </div>
                            <div class="progress-details">
<span class="progress-label">Lunas <?php echo e($paidWeeks); ?>/<?php echo e($totalWeeks); ?> Minggu</span>
<span class="progress-amount">Rp <?php echo e(number_format($kasSudahBayar, 0, ',', '.')); ?></span>
                            </div>
                        </div>
                        <div class="payment-weeks">
<?php $__currentLoopData = $weeklyPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $paidClass = $payment->status == 'paid' ? 'paid' : 'unpaid';
                                    $statusIcon = $payment->status == 'paid' ? '✓' : '○';
                                ?>
                                <div class="week-item <?php echo e($paidClass); ?>">
                                    <span class="week-label">Minggu <?php echo e($payment->week_number); ?></span>
                                    <span class="week-status"><?php echo e($statusIcon); ?></span>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectsc - Copy\resources\views/siswa/dashboard.blade.php ENDPATH**/ ?>