...
<div class="container">
        ...
        <table class="header-table">
            <tr>
                <td width="70%" class="school-info">
                    ...
                    <div class="period">
                        Periode Januari - <?php echo e($endMonthName); ?> Tahun <?php echo e($year); ?>
    ...
    <div class="summary">
        <table class="summary-table">
            <tr>
                <td width="33%">
                    <div class="summary-title">UANG MASUK</div>
                    <div class="summary-value">Rp <?php echo e(number_format($income,0,',','.')); ?></div>
                </td>
                <td width="33%">
                    <div class="summary-title">UANG KELUAR</div>
...
<?php /**PATH C:\laragon\www\projectsc - Copy\resources\views/bendahara/laporan-keuangan-tahunan-cetak.blade.php ENDPATH**/ ?>