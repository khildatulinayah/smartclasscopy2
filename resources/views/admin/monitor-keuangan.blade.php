                ...
                <div class="table-header">
                    <div class="table-title-section">
                        ...
                        <div class="month-navigation">
                            <a href="{{ route('admin.monitor.keuangan', ['month' => $prevDate->month, 'year' => $prevDate->year]) }}" class="nav-btn">
                            ...
                            <a href="{{ route('admin.monitor.keuangan', ['month' => $nextDate->month, 'year' => $nextDate->year]) }}" class="nav-btn">
                                Next
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="table-container">
                        <table class="data-table" id="transactionsTable">
                            ...
                            <tbody>
                                ...
                                <tr data-description="{{ strtolower($transaction->description) }}" data-type="{{ strtolower($transaction->type) }}" data-id="{{ $transaction->id }}" data-receipt-path="{{ $transaction->receipt_path ?? '' }}">
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $transaction->date->format('d M Y') }}</td>
                                    <td>{{ $transaction->student->name ?? $transaction->creator->name ?? '-' }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <button class="detail-btn" onclick="showTransactionDetail({{ $transaction->id }})" title="Lihat detail transaksi">
                                            <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
