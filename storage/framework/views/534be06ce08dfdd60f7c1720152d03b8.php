                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="avatar-upload-container">
                                    <img src="<?php echo e($student->profile_photo ? asset('storage/' . $student->profile_photo) : 'https://ui-avatars.com/api/?name=' . urlencode($student->name) . '&background=3b82f6&color=fff&size=120'); ?>" class="avatar-preview" alt="<?php echo e($student->name); ?>" id="avatarPreview">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let hasCustomPhoto = !!'<?php echo e($student->profile_photo); ?>';
