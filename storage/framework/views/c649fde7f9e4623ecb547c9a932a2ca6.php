    ...
    <div class="container">
        <div class="header">
            <div class="header-top">
                ...
                <div>
<?php $logoPath = public_path('images/logo2.png'); ?>
                <img src="file://<?php echo e($logoPath); ?>" alt="Logo" class="logo-right" style="object-fit:contain;" onerror="this.style.display='none'">
                </div>
            </div>
        </div>
