...
<div class="dashboard-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('sekretaris.absensi')); ?>" class="nav-item active">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <span>Absensi</span>
            </a>
            <a href="<?php echo e(route('sekretaris.tracker')); ?>" class="nav-item">
    ...
    <div class="main-area">
        <main class="main-content">
                ...
                <div class="greeting-card">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p class="greeting-subtitle">Update kehadiran siswa untuk <?php echo e(\Carbon\Carbon::parse($selectedDate)->locale('id')->format('l, d F Y')); ?></p>
                        </div>
            ...
            <section class="feature-cards mb-8" style="grid-template-columns: 1fr auto 1fr; gap: 12px;">
                <a href="<?php echo e(route('sekretaris.absensi', ['date' => \Carbon\Carbon::parse($selectedDate)->subDay()->format('Y-m-d')])); ?>" class="feature-card text-center" style="background: linear-gradient(135deg, #f8fafc, #e2e8f0);">
                ...
                <a href="<?php echo e(route('sekretaris.absensi')); ?>" class="feature-card text-center" style="background: linear-gradient(135deg, #3b82f6, #2563eb); color: white;">
                ...
                <a href="<?php echo e(route('sekretaris.absensi', ['date' => \Carbon\Carbon::parse($selectedDate)->addDay()->format('Y-m-d')])); ?>" class="feature-card text-center" style="background: linear-gradient(135deg, #f8fafc, #e2e8f0);">
